...
<div class="publications">
  ...
  <h3 style="margin: 10px 0 4px;">Conference</h3>
  <ol class="bibliography" style="margin: 0; padding-left: 20px;">

  <li>
    <div class="pub-row">
      <div class="col-sm-9" style="padding-left: 20px; padding-bottom: 10px;">
  ...
  <h3 style="margin: 10px 0 4px;">Technical Report</h3>
  <ol class="bibliography" style="margin: 0; padding-left: 20px;">
    <li>
      <div class="pub-row">
        <div class="col-sm-9" style="padding-left: 20px; padding-bottom: 10px;">
  ...
  <h3 style="margin: 10px 0 4px;">Preprint</h3>
  <ol class="bibliography" style="margin: 0; padding-left: 20px;">
